...
<head>
    <meta charset="utf-8">
    <title>Surat Kesediaan Seminar</title>
    <style>
...
<body>
    ...
    <div class="isi-surat">
        <div class="judul-surat">
            <h3>SURAT KESEDIAAN SEMINAR</h3>
            @if(isset($surat))
                <p>Nomor: {{ $surat->no_surat }}</p>
            @endif
        </div>

        <p>Yang bertanda tangan di bawah ini, menyatakan bersedia menjadi Pembimbing untuk mahasiswa berikut:</p>
        ...
        <table class="identitas-table">
            ...
            <tr>
                <td>Judul Seminar</td>
                <td>:</td>
                <td><em>"{{ $seminar->judul }}"</em></td>
            </tr>
        </table>

        <p>Demikian surat kesediaan ini dibuat untuk dipergunakan sebagai syarat penerbitan Surat Undangan Seminar.</p>
            ...
            <table class="ttd-table">
                <tr>
                    <td>
                        ...
                        <br><br><br><br>
                        <p><strong>{{ $seminar->pembimbing1->nama ?? '(..........................................)' }}</strong></p>
                        <p>NIDN. {{ $seminar->pembimbing1->nidn ?? '..........................' }}</p>
                    </td>
                    <td>
                        <p>Pembimbing Pendamping (2),</p>
                        <br><br><br><br>
                        <p><strong>{{ $seminar->pembimbing2->nama ?? '(..........................................)' }}</strong></p>
                        <p>NIDN. {{ $seminar->pembimbing2->nidn ?? '..........................' }}</p>
                    </td>
                </tr>
            </table>
        </div>
